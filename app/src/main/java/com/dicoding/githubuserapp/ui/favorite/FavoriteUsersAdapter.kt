...
import com.dicoding.githubuserapp.helper.FavoriteUserDiffCallback
...
class FavoriteUsersAdapter(private val favoriteUsers: ArrayList<FavoriteUser>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Glide.with(holder.itemView.context).load(favoriteUser.avatarUrl).into(holder.civUser)

        holder.tvUsername.text = favoriteUser.login
